...
public class PlayerAppController {
    ...
    @GetMapping("/player_career_info/{name}")
    ...
    @GetMapping("/player_t20i_info/{name}")
    ...
    @GetMapping("/players_odi_info/{name}")
    ...
    @GetMapping("/players_test_info/{name}")
    ...
    @GetMapping("/players_personal_info/{name}")
    ...
    @GetMapping("/top_5_experienced_players_data/{gender}")
    ...
    @GetMapping("/top_5_century_scorer_info/{gender}")
    ...
    @GetMapping("/top_3_ODI_wicket_takers_info/{gender}")
